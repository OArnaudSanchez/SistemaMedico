namespace SistemaControlMedico.Models
{
    ...
    public partial class Ingresos
    {
        ...
        [DisplayFormat(DataFormatString = "{0:dd-MM-yyyy}", ApplyFormatInEditMode = true), Display(Name ="Fecha de Ingreso"),Required(ErrorMessage ="El campo {0} No puede estar Vacio")]
