namespace SistemaControlMedico.Models
{
    ...
    public partial class Pacientes
    {
        ...
        [Required(ErrorMessage ="El campo {0} No puede estar Vacio"),StringLength(50),Display(Name ="Nombre Paciente"), DataType(DataType.Text, ErrorMessage ="Solo se permiten Letras")]
